...
@interface JacketsdfgdfViewController ()
...
@implementation JacketsdfgdfViewController
...
- (instancetype)init {
    ...
    if (self) {
        ...
        [self.behaviors addObject:[ROFilterBehavior behaviorViewController:self filterControllerClass:[JacketsdfgdfFilterViewController class]]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ProductsDSItem *item = self.items[(NSUInteger)indexPath.row];
    JacketsdfgdfDetailViewController *destinationViewController = [JacketsdfgdfDetailViewController new];
