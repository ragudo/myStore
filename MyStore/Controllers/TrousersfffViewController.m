...
#import "TrousersfffFilterViewController.h"
...
@interface TrousersfffViewController ()
...
@implementation TrousersfffViewController
...
- (instancetype)init {
    ...
    if (self) {
        ...
        [self.behaviors addObject:[ROFilterBehavior behaviorViewController:self filterControllerClass:[TrousersfffFilterViewController class]]];
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"Trousersfff"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ProductsDSItem *item = self.items[(NSUInteger)indexPath.row];
    TrousersfffDetailViewController *destinationViewController = [TrousersfffDetailViewController new];
